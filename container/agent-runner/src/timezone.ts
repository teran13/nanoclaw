 ...
 *
 * The weekday is named rather than left to be derived from the date: an agent
 * reading "Mar 9, 2026" has to compute the day of the week itself, and gets it
 * wrong often enough to answer "Sunday" on a Monday.
 */
